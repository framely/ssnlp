...
// source: src/edu/stanford/nlp/process/WhitespaceLexer.flex
...
class WhitespaceLexer {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    "\11\0\1\1\1\2\2\3\1\4\20\0\2\3\1\1"+
    "\144\0\1\3\u01fa\0\1\1\177\0\7\1\1\0\3\1"+
    "\35\0\2\3\65\0\1\1\240\0\1\1\377\0";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\1\2\1\3\2\4\1\5\1\2\5\0\1\3\12\0"+
    "\1\4\2\0";
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1:
            { return tokenFactory.makeToken(yytext(), Math.toIntExact(yychar), yylength());
            }
            // fall through
          case 4: break;
          case 2:
          ...
          case 5: break;
          case 3:
            { return tokenFactory.makeToken(NEWLINE, Math.toIntExact(yychar), yylength());
            }
            // fall through
          case 6: break;
          default:
